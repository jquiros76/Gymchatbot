        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <button
                onClick={() => { setIsOpen(false); setMessages([]); setCurrentNode("welcome"); setUserData({}); setLeadScore(0); }}
                style={{
          ...
          <div style={{
            ...
            <span style={{ color: "#334155", fontSize: 11 }}>⚡ PowerGym FitBot — Powered by AI</span>
          </div>
        </div>
      )}
